...
/* harmony import */ var _actions_core__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(230);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(747);



try {
  const context = JSON.parse((0,fs__WEBPACK_IMPORTED_MODULE_1__.readFileSync)(process.env.GITHUB_EVENT_PATH));
  const branch = context.pull_request.head.ref;
  (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.exportVariable)("SOURCE_BRANCH", branch);
} catch (err) {
